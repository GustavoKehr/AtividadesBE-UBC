...
os valores de uma variável "i" enquanto esta for menor ou igual a 1000.
*/
...
} while (i <= 1000); // Verifica se o valor da variável i ainda é menor ou igual a 1000, se sim, o bloco de código dentro do "do" é executado novamente
